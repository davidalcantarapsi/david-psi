...
export default function ContactSection({
  ...
  const description = isBlog
    ...
    : "Entre em contato para agendar sua primeira sessão com discrição, clareza e método.";
  ...
  return (
    ...
    >
      <div className="absolute bottom-0 right-0 z-0 h-[360px] w-[360px] opacity-[0.06]" aria-hidden>
        <Image src="/logo-amarelo.svg" alt="" fill sizes="360px" className="object-contain" />
      </div>
