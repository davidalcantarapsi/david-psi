...
export default function ContactSection({
  ...
  const description = isBlog
    ? "Entre em contato para sugerir tópicos de artigos ou agendar uma consulta."
    : "Entre em contato para agendar sua primeira sessão. Estarei feliz em ajudar na sua jornada de autoconhecimento e bem-estar.";
  const emailLabel = "Enviar e-mail";
  const whatsappLabel = "Mandar mensagem";
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row sm:flex-wrap">
          <a
            ...
            className="rounded-lg border-2 border-accent bg-white px-8 py-3 font-semibold text-primary-500 transition-colors hover:bg-accent-50"
          >
            {emailLabel}
          </a>
          <a
